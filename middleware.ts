 ...
 * This middleware checks for auth cookie presence
 */

import { NextResponse } from 'next/server';
import type { NextRequest } from 'next/server';

// Cookie name constant (duplicated here to avoid Edge-incompatible imports)
...
const PUBLIC_ROUTES = [
  '/login',
  '/api/auth/login',
  '/api/auth/session', // Session check doesn't require auth
];
...
export function middleware(request: NextRequest) {
  ...
  // Check if this is a protected API route
    ...
    // Check for auth cookie (instead of Authorization header)
